...
<!--end of header-->
 <div class="hidder" id="wrapper">
		...
		<center><h1 style="font-family:Orbitron">Civil Engineering Department.</h1></center><br>
		   ...
		   <hr>
		<img align="right" style="width:60%;height:auto;box-shadow: 0 0 20px #000;border-radius:10px; margin-left:30px;"src="images/civil hod desk.JPG">
...
Dr. Rajesh Kumar<br>
Professor & Head<br> Civil Engineering Department.<br>
Email-id:-Email:  rajeshkumar@ccet.ac.in
</h5>
    </div>
 </div> 
