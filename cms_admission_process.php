...
<?php include 'cms_sidebar.php'; ?> 
 <div id="content" class="span10">
			...
			<div class="row-fluid sortable">
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon edit"></i><span class="break"></span> Admission</h2>
						<div class="box-icon">
        ...
        <?php 
		$event=$_POST["event"];
		if($event=="degreebrochure")
		{
$target_dir = "pdf/";
$target_file = $target_dir ."degreebrochure.pdf";
$uploadOk = 1;
...
else 
{
   ...
   {
	   echo '<h3>Degree Brochure Uploaded Succesfully</h3>';
   }
}
		}
		
		else if($event=="puleetbrochure")
		{
			$target_dir = "pdf/";
$target_file = $target_dir ."puleetbrochure.pdf";
$uploadOk = 1;
$imageFileType = pathinfo($target_file,PATHINFO_EXTENSION);
// Check if image file is a actual image or fake image
// Check if $uploadOk is set to 0 by an error
...
else 
{
   ...
   {
	   echo 'PULEET Uploaded Succesfully';
   }
}
		}
		...
		{
			$target_dir = "pdf/";
$target_file = $target_dir ."CUTOFF.pdf";
$uploadOk = 1;
$imageFileType = pathinfo($target_file,PATHINFO_EXTENSION);
// Check if image file is a actual image or fake image
// Check if $uploadOk is set to 0 by an error
...
else 
{
   if($img1=move_uploaded_file($_FILES["fileToUpload"]["tmp_name"], $target_file))
   {
	   echo 'Cut Off List Uploaded Succesfully';
   }
}
		}
