...
<head>
	...
	<!-- start: Meta -->
	<meta charset="utf-8">
	<title>CCET CMS DASHBOARD</title>
	<meta name="description" content="Bootstrap Metro Dashboard">
	<meta name="author" content="Team Bookrunch">
...
<?php include 'cms_sidebar.php'; ?> 
			...
			<div class="row-fluid">
				...
				<div class="widget span3 red" onTablet="span6" onDesktop="span3">
					...
					<h2><span class="glyphicons pie_chart"><i></i></span> Browser / OS</h2>
...
// get browser
if($obj->showInfo('browser')=="Google Chrome")
{?>
...
if($obj->showInfo('browser')=="Firefox")
{
	?>
	<div class="browserStat big">
...
?>
						...
						<div class="browserStat">
							...
							<span>Operating System: <?php echo $obj->showInfo('os'); ?> </span>
						</div>	
