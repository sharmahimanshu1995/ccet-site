 ...
 <div id="wrapper">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" id="sidebar-wrapper" role="navigation" >
            <ul class="nav sidebar-nav">
                ...
                <li>
                    <a href="history.html#vision">Vision</a>
                </li>
                <li>
                    <a href="history.html#mission">Mission</a>
                </li>
                <li>
        ...
        <div id="page-content-wrapper" style="text-align:justify;padding-left:2%;padding-right:2%;padding-bottom:5%">
           ...
           <h2 style="">QUALITY CAMPUS</h2>
		   <hr>
		   <p>  
		   This page is under construction sorry for inconvinience.
		   </p>
