...
<html lang="en">
<head>
<title>Academics | Add Prospectus</title>
 ...
 <?if($_SESSION["type"]=="admin"){ ?> 
		...
		<div class="row-fluid">
			...
			<ul class="breadcrumb">
					...
					<li>
						<i class="icon-edit"></i>
						<a href="#">Academics Prospectus, Calender, Forms</a>
					</li>
				</ul>
							<div class="row-fluid sortable">
					<div class="box span12">
						<div class="box-header" data-original-title>
							<h2><i class="halflings-icon edit"></i><span class="break"></span> Academic Forms</h2>
							<div class="box-icon">
						...
						<h1>Add Academic Forms</h1><br><br><br>              
			...
			<div class="row-fluid sortable">
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon edit"></i><span class="break"></span>Academic Prospectus</h2>
						<div class="box-icon">
							<a href="#" class="btn-setting"><i class="halflings-icon wrench"></i></a>
							<a href="#" class="btn-minimize"><i class="halflings-icon chevron-up"></i></a>
							<a href="#" class="btn-close"><i class="halflings-icon remove"></i></a>
					...
					<div class="box-content"> 
					<form action="cms_academic_process.php" method="post" class="form-horizontal" name="frm1" enctype="multipart/form-data">
								<div class="control-group">
											<label class="control-label" for="focusedInput">Please upload a file(Pdf format only)</label>
											<div class="controls">
											  <input class="input-file uniform_on" id="fileInput" type="file" name="fileToUpload">
											<input type="hidden" name="event" value="prospectus">
											</div>
								</div>    
								<div class="form-group">        
								  <div class="col-sm-offset-2 col-sm-10">
									  <button type="submit" id="login" class="btn btn-primary">Upload Prospectus</button>
								  </div>
								</div>
							</form>   
					</div>
					...
					<div class="box span12">
						<div class="box-header" data-original-title>
							<h2><i class="halflings-icon edit"></i><span class="break"></span> Academic Calender</h2>
							<div class="box-icon">
								<a href="#" class="btn-setting"><i class="halflings-icon wrench"></i></a>
								<a href="#" class="btn-minimize"><i class="halflings-icon chevron-up"></i></a>
								<a href="#" class="btn-close"><i class="halflings-icon remove"></i></a>
						...
						<div class="box-content">       
							<h1>Update Academic Calender</h1><br><br><br>              
							<form action="cms_academic_process.php" method="post" class="form-horizontal" name="frm2" enctype="multipart/form-data">
								<div class="control-group">
											<label class="control-label" for="focusedInput">Please upload a file(Pdf format only)</label>
											<div class="controls">
											
											  <input class="input-file uniform_on" id="fileInput" type="file" name="fileToUpload">
											<input type="hidden" name="event" value="calender">
											</div>
								</div>   
								<div class="form-group">        
									<div class="col-sm-offset-2 col-sm-10">
										<button type="submit" id="login" class="btn btn-primary">Update Academic Calender</button>
									</div>
								</div>
							</form>      
						</div>
