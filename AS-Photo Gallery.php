...
<html lang="en" class="no-js">
	<head>
		...
		<title>CCET Applied Science Department Photo Gallery</title>
		<meta name="description" content="CCET Applied Science Department Photo Gallery" />
		<meta name="keywords" content="CCET, Chandigarh College of Engineering and Technology,Applied Science, CCET Applied Science, CCET Physics, CCET Chemistry, CCET Communication lab" />
		<meta name="author" content="Sahil Verma" />
		<link rel="shortcut icon" href="../favicon.ico">
		<link rel="stylesheet" type="text/css" href="css/grid gallery demo.css" />
		<link rel="stylesheet" type="text/css" href="css/grid gallery component.css" />
 ...
 <link rel="stylesheet" href="css/style1.css">
  ...
  <!--end of header-->
  <h2 style="font-family:Orbitron">Applied Sciences Department</h2>
		   <hr>
			<center><h3 style="font-family:Orbitron">Photo Gallery</h3></center>
